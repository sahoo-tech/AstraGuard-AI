...
var _config = {
  ...
  child._start = _roundPrecise((_isNumber$1(position) ? position : position || timeline2 !== _globalTimeline ? _parsePosition(timeline2, position, child) : timeline2._time) + child._delay);
...
var _gsap = {
  ...
  registerEffect: function registerEffect(_ref3) {
    ...
    _effects[name] = function(targets, vars, tl) {
      return effect(toArray$1(targets), _setDefaults(vars || {}, defaults22), tl);
    };
    if (extendTimeline) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _svgPathExp = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig, _scientific = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/ig, _DEG2RAD = Math.PI / 180, _sin = Math.sin, _cos = Math.cos, _abs = Math.abs, _sqrt = Math.sqrt, _isNumber = function _isNumber3(value) {
  return typeof value === "number";
}, _roundingNum = 1e5, _round$1 = function _round(value) {
...
}, _bigNum = 1e20, _round3 = function _round4(value) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const gridImages = gsapWithCSS.utils.toArray(".img");
          ...
          onComplete: () => {
            gridImages.forEach((img, index) => {
              ...
              if (cycle === totalCycles - 1 && img === heroImage) {
                imgElement.src = "/assets/img/as1.jpeg";
                gsapWithCSS.set(".hero-img img", { scale: 2 });
              } else {
  ...
  function setupInitialStates() {
    ...
    gsapWithCSS.set(introCopy.words, {
      y: "110%"
    });
    gsapWithCSS.set(titleHeading.words, {
      y: "110%"
    });
  }
  function init4() {
  ...
  function createAnimationTimelines() {
    const overlayTimeline = gsapWithCSS.timeline();
    const imagesTimeline = gsapWithCSS.timeline();
    ...
    imagesTimeline.to(".img", {
      ...
      onStart: () => {
        setTimeout(() => {
          startImageRotation();
          gsapWithCSS.to(".loader", { opacity: 0, duration: 0.3 });
        }, 1e3);
      }
    });
    ...
    imagesTimeline.to(".hero-img", {
      ...
      ease: "hop",
      onStart: () => {
        gsapWithCSS.to(".hero-img img", {
          scale: 1,
          duration: 1.5,
          ease: "hop"
        });
        gsapWithCSS.to(".banner-img", { scale: 1, delay: 0.5, duration: 0.5 });
        gsapWithCSS.to("nav", { y: "0%", duration: 1, ease: "hop", delay: 0.25 });
      }
    });
    imagesTimeline.to(
      ".banner-img-1",
...
const projectsData = [
  {
    name: "Lunar Eclipse",
    director: "System Status: Active",
    location: "Orbital Phase: Alpha"
  },
  {
    name: "Sentinel-X",
    director: "Mission Control: GO",
    location: "Altitude: 500 km"
  },
  {
    name: "Anomaly Detection",
    director: "AI Processor: Online",
    location: "Coverage: Global"
  },
  {
    name: "Threat Assessment",
    director: "Analysis: Real-time",
    location: "Response: Immediate"
  },
  {
    name: "Satellite Guardian",
    director: "Security Level: Critical",
    location: "Network: Secure"
  },
  {
    name: "Data Relay Network",
    director: "Signal Strength: 99.8%",
    location: "Bandwidth: Full"
  },
  {
    name: "Quantum Encryption",
    director: "Protocol: Military-Grade",
    location: "Authentication: Verified"
  },
  {
    name: "Predictive Analytics",
    director: "ML Model: v8.4",
    location: "Accuracy: 99.2%"
  },
  {
    name: "Crisis Response",
    director: "Deployment: Active",
    location: "Teams: Mobilized"
  },
  {
    name: "Autonomous Monitoring",
    director: "Drones: 24/7",
    location: "Coverage: 360°"
  },
  {
    name: "Early Warning System",
    director: "Sensors: Calibrated",
    location: "Detection: 0.1s"
  },
  {
    name: "Command Center",
    director: "Operators: 50",
    location: "Uptime: 99.99%"
  },
  {
    name: "Signal Processing",
    director: "Latency: <1ms",
    location: "Throughput: 10Gbps"
  },
  {
    name: "Orbital Mechanics",
    director: "Trajectory: Optimal",
    location: "Stability: ±0.5km"
  },
  {
    name: "Emergency Protocol",
    director: "Activation: 2-Step",
    location: "Response Time: <60s"
  },
  {
    name: "Frontier Expansion",
    director: "Mission: Critical",
    location: "Satellites: 256"
  }
];
